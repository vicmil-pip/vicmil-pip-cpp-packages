...
def install():
    # Download library files for opengl and sdl
    ...
    if platform.system() == "Windows":
        ...
        drive_url = "https://drive.google.com/file/d/1RJS3ciVAHyfCJ8btsjTx6I5ArHYfOczG/view?usp=drive_link"
    ...
    if platform.system() == "Linux":
        untar_file(
            ...
            extract_to=get_directory_path(__file__) + "/sdl_opengl",
            delete_tar=False
        )
